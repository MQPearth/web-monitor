...
namespace Poco {
    namespace Util {
        ...
        private:
            ...
            Poco::XML::Node *
            findNode(std::string::const_iterator &it, const std::string::const_iterator &end, Poco::XML::Node *pNode,
            ...
            static Poco::XML::Node *
            findElement(const std::string &attr, const std::string &value, Poco::XML::Node *pNode);
