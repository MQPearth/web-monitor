...
namespace Poco {
    namespace Net {
        ...
        public:
            ...
            OAuth10Credentials(const std::string &consumerKey, const std::string &consumerSecret,
                               const std::string &token, const std::string &tokenSecret);
            ...
            void authenticate(HTTPRequest &request, const Poco::URI &uri, const Poco::Net::HTMLForm &params,
        ...
        protected:
            ...
            void signHMACSHA1(Poco::Net::HTTPRequest &request, const std::string &uri,
                              const Poco::Net::HTMLForm &params) const;
            ...
            std::string createSignature(const Poco::Net::HTTPRequest &request, const std::string &uri,
                                        const Poco::Net::HTMLForm &params, const std::string &nonce,
