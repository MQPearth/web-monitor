    ...
    namespace Net {
        ...
        public:
            ...
            /// the reactor.
            {
                ...
                _pReactor = &reactor;
                _pReactor->addEventHandler(_socket, Poco::Observer<SocketAcceptor, ReadableNotification>(*this,
                                                                                                         &SocketAcceptor::onAccept));
            }
            ...
            {
                if (_pReactor) {
                    _pReactor->removeEventHandler(_socket, Poco::Observer<SocketAcceptor, ReadableNotification>(*this,
                                                                                                                &SocketAcceptor::onAccept));
                }
            }
