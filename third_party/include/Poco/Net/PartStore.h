...
namespace Poco {
    namespace Net {
        ...
        {
        public:
            virtual PartSource *createPartStore(const std::string &content, const std::string &mediaType,
        ...
        public:
            PartSource *createPartStore(const std::string &content, const std::string &mediaType,
