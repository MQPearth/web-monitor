...
namespace Poco {
    namespace Net {
        ...
        {
        public:
            HTTPServer(HTTPRequestHandlerFactory::Ptr pFactory, Poco::UInt16 portNumber = 80,
            ...
            HTTPServer(HTTPRequestHandlerFactory::Ptr pFactory, const ServerSocket &socket,
            ...
            HTTPServer(HTTPRequestHandlerFactory::Ptr pFactory, Poco::ThreadPool &threadPool,
                       const ServerSocket &socket, HTTPServerParams::Ptr pParams);
            /// Creates the HTTPServer, using the given ServerSocket.
            ///
            /// The server takes ownership of the HTTPRequstHandlerFactory
            /// and deletes it when it's no longer needed.
