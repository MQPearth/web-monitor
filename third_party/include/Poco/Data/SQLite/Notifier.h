        ...
        namespace SQLite {
            ...
            public:
                ...
                Notifier(const Session &session,
                         EnabledEventType enabled = SQLITE_NOTIFY_UPDATE | SQLITE_NOTIFY_COMMIT |
                ...
                static void
                sqliteUpdateCallbackFn(void *pVal, int opCode, const char *pDB, const char *pTable, Poco::Int64 row);
