...
namespace Poco {
    ...
    public:
        ...
        bool equals(const AbstractDelegate<TArgs> &other) const {
            ...
            return pOtherDelegate && _receiverObject == pOtherDelegate->_receiverObject &&
    ...
    template<class TObj, class TArgs>
    inline Expire <TArgs>
    delegate(TObj *pObj, void (TObj::*NotifyMethod)(const void *, TArgs &), Timestamp::TimeDiff expireMillisecs) {
    ...
    template<class TObj, class TArgs>
    inline Expire <TArgs>
    delegate(TObj *pObj, void (TObj::*NotifyMethod)(TArgs &), Timestamp::TimeDiff expireMillisecs) {
    ...
    template<class TObj>
    inline Expire<void>
    delegate(TObj *pObj, void (TObj::*NotifyMethod)(const void *), Timestamp::TimeDiff expireMillisecs) {
