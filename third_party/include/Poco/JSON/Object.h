...
namespace Poco {
    namespace JSON {
        ...
        public:
            ...
            /// efficient as possible (when needed, it will be generated upon request_target_host).
...
//
        ...
        inline bool Object::isArray(ConstIterator &it) const {
            return it != _values.end() &&
                   (it->second.type() == typeid(Array::Ptr) || it->second.type() == typeid(Array));
        }
        ...
        inline bool Object::isObject(ConstIterator &it) const {
            return it != _values.end() &&
                   (it->second.type() == typeid(Object::Ptr) || it->second.type() == typeid(Object));
        }
