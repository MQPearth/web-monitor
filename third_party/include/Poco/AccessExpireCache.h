...
namespace Poco {
    ...
    class AccessExpireCache
            : public AbstractCache<TKey, TValue, AccessExpireStrategy<TKey, TValue>, TMutex, TEventMutex>
    ...
    public:
        AccessExpireCache(Timestamp::TimeDiff expire = 600000) :
                AbstractCache<TKey, TValue, AccessExpireStrategy<TKey, TValue>, TMutex, TEventMutex>(
                        AccessExpireStrategy<TKey, TValue>(expire)) {
        }
